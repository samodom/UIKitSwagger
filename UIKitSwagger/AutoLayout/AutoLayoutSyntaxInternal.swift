...
internal func BuildConstantRelationConstraint(
    attributedItem attributedItem: AutoLayoutAttributedItem,
    constant: CGFloat,
...
internal func BuildConstraintFromOperands(
    attributedItem attributedItem: AutoLayoutAttributedItem,
    offset: AutoLayoutAttributedItemOffset,
    relation: NSLayoutRelation = .Equal
    ) -> NSLayoutConstraint {
