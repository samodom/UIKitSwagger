...
public func +=(
    controller: UIAlertController, textFieldConfigurationHandler:
    @escaping UIAlertTextFieldConfigurationHandler
    ) {
...
public func +=(
    ...
    textFieldConfigurationHandlers: [UIAlertTextFieldConfigurationHandler]
    ) {
