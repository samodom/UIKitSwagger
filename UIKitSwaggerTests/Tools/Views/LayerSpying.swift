...
internal extension CALayer {
    ...
    private static var setNeedsDisplayIsSwizzled: Bool {
        get {
            let flag = thisClass.associationForKey(LayerSpyingAssociationKeys.SetNeedsDisplayIsSwizzledKey) as? Bool
            return flag ?? false
        }
        set {
    ...
    private static let thisClass: Class = NSClassFromString("CALayer")!
}
