...
class ConstraintReversalTests: XCTestCase {
    ...
    func testEqualReversal() {
        ...
        XCTAssertEqual(reversed.firstItem as NSObject, constraint.secondItem as NSObject, "The original second item should be the first item when reversed")
        ...
        XCTAssertEqual(reversed.secondItem as NSObject, constraint.firstItem as NSObject, "The original first item should be the second item when reversed")
    ...
    func testNegativeConstantConstraintReversed() {
        ...
        XCTAssertEqual(positive.firstItem as NSObject, constraint.secondItem as NSObject, "The original second item should be the first item when reversed")
        ...
        XCTAssertEqual(positive.secondItem as NSObject, constraint.firstItem as NSObject, "The original first item should be the second item when reversed")
