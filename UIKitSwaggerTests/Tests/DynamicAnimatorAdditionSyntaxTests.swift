...
class DynamicAnimatorAdditionSyntaxTests: XCTestCase {
    ...
    func testAddingDynamicBehaviorWithOperator() {
        animator += behavior1
        XCTAssertEqual(animator.behaviors, [behavior1], "The behavior should be added to the animator")
    }

    func testAddingDynamicBehaviorArrayWithOperator() {
        animator += [behavior1, behavior2, behavior3]
        XCTAssertEqual(animator.behaviors, [behavior1, behavior2, behavior3], "The behaviors should be added to the animator in the order provided")
    }
    ...
    func testRemovingDynamicBehaviorWithOperator() {
        ...
        animator -= behavior2
        XCTAssertEqual(animator.behaviors, [behavior1, behavior3], "The behavior should be removed from the animator")
    }
    ...
    func testRemovingDynamicBehaviorArrayWithOperator() {
        ...
        XCTAssertEqual(animator.behaviors, [behavior2], "The behaviors should be removed from the animator")
    }
