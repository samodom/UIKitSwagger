...
class ViewControllerLayoutAttributesTests: XCTestCase {
    ...
    func testLeftAttributedItem() {
        ...
        XCTAssertEqual(attributedItem.attribute, .Left, "The attribute should be the view's left side")
    }

    func testLeftMarginAttributedItem() {
        attributedItem = controller.leftMargin
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .LeftMargin, "The attribute should be the view's left margin")
    }

    func testRightAttributedItem() {
        attributedItem = controller.right
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .Right, "The attribute should be the view's right side")
    }

    func testRightMarginAttributedItem() {
        attributedItem = controller.rightMargin
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .RightMargin, "The attribute should be the view's right margin")
    }
    ...
    func testTopAttributedItem() {
        ...
        XCTAssertEqual(attributedItem.attribute, .Bottom, "The attribute should be the layout guide's bottom side")
    }

    func testTopMarginAttributedItem() {
        attributedItem = controller.topMargin
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .TopMargin, "The attribute should be the view's top margin")
    }
    ...
    func testBottomAttributedItem() {
        ...
        XCTAssertEqual(attributedItem.attribute, .Top, "The attribute should be the layout guide's top side")
    }

    func testBottomMarginAttributedItem() {
        attributedItem = controller.bottomMargin
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .BottomMargin, "The attribute should be the view's bottom margin")
    }

    func testLeadingAttributedItem() {
        attributedItem = controller.leading
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .Leading, "The attribute should be the view's leading side")
    }

    func testLeadingMarginAttributedItem() {
        attributedItem = controller.leadingMargin
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .LeadingMargin, "The attribute should be the view's leading margin")
    }

    func testTrailingAttributedItem() {
        attributedItem = controller.trailing
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .Trailing, "The attribute should be the view's trailing side")
    }

    func testTrailingMarginAttributedItem() {
        attributedItem = controller.trailingMargin
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .TrailingMargin, "The attribute should be the view's trailing margin")
    }

    func testWidthAttributedItem() {
        attributedItem = controller.width
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .Width, "The attribute should be the view's width dimension")
    }

    func testHeightAttributedItem() {
        attributedItem = controller.height
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .Height, "The attribute should be the view's height dimension")
    }

    func testCenterXAttributedItem() {
        attributedItem = controller.centerX
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .CenterX, "The attribute should be the view's center X value")
    }

    func testCenterXInMarginsAttributedItem() {
        attributedItem = controller.centerXInMargins
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .CenterXWithinMargins, "The attribute should be the view's center X within margins value")
    }

    func testCenterYAttributedItem() {
        attributedItem = controller.centerY
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .CenterY, "The attribute should be the view's center Y value")
    }

    func testCenterYInMarginsAttributedItem() {
        attributedItem = controller.centerYInMargins
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .CenterYWithinMargins, "The attribute should be the view's center Y within margins value")
    }

    func testBaselineAttributedItem() {
        attributedItem = controller.baseline
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .Baseline, "The attribute should be the view's baseline")
    }

    func testFirstBaselineAttributedItem() {
        attributedItem = controller.firstBaseline
        XCTAssertEqual(attributedItem.item as! UIView, controller.view, "The item should be the view controller's view")
        XCTAssertEqual(attributedItem.attribute, .FirstBaseline, "The attribute should be the view's first baseline")
    }
